...
const toCamel = (record: any) => ({
  ...
  terms: record.terms,
  termsOfPayment: record.terms_of_payment,
  // Company Information
  companyName: record.company_name,
  companyContactPerson: record.company_contact_person,
  companyAddress: record.company_address,
  companyPhone: record.company_phone,
  companyEmail: record.company_email,
  companySiret: record.company_siret,
  companyVat: record.company_vat,
...
const toDb = (body: any) => ({
  ...
  terms: body.terms,
  terms_of_payment: body.termsOfPayment,
  // Company Information
  company_name: body.companyName,
  company_contact_person: body.companyContactPerson,
  company_address: body.companyAddress,
  company_phone: body.companyPhone,
  company_email: body.companyEmail,
  company_siret: body.companySiret,
  company_vat: body.companyVat,
